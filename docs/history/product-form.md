...
> ⚠️ **历史记录（已归档）**：本文是 2026-08-21「跳回软件 vs 插件」产品形态调研记录。三层形态（跳转链接 → 插件薄壳 → MCP）的实现结论已由 [`docs/design.md`](../design.md) §6.8、[`docs/history/plugin-evaluation.md`](plugin-evaluation.md) 与 [`docs/roadmap.md`](../roadmap.md) 承接。保留本文作决策起因与调研依据。
